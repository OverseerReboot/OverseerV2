...
if (empty($_SESSION['character'])) {
    ...
    if ($computability == 0) {
        if ($compugood == true) {
            echo "You need a computer in storage or equipped to wire grist to other players.</br>";
        }
        $compugood = false;
    }
    ...
    if ($compugood == true) {
        ...
        foreach ($gristarray as $grist) {
            ...
            if ($griststr[0]) {
                echo '<option value="' . $griststr[0] . '">' . $griststr[0] . '</option>';
            } //Produce an option in the dropdown menu for this grist.
        }
    ...
    foreach ($grists as $grist) {
        ...
        if ($gristtype != '9782' && $gristtype != '7') {
            ...
            if ($gristtype != 'Dev_Grist') {
                $gristrow = $gristlist[$gristtype];
            }
            $extension = ".png";
            if ($gristrow['gif'] == 1) {
                $extension = ".gif";
