        ...
        foreach ($characterids as $characterid) {
            ...
            if ($row['session'] == $sessionrow['ID']) { //Paranoia: Player is a participant in this session.
                ...
                if ($row['abstratus']) {
                    ...
                    if ($abstratus != "") {
                        echo "Strife Specibus: $abstratus</br>";
                    }
                } else {
                    echo "Strife Specibus: Unassigned</br>";
                }
                ...
                if ($row['strifedeck']) {
                    ...
                    if ($weaponids[0] != "") {
                        ...
                        if ($weaponids[1] != "") {
                            echo ", " . $itemnames[$weaponids[1]];
                        }
                    } elseif ($weaponids[1] != "") {
                        echo $itemnames[$weaponids[1]];
                    }
                } else {
                    echo "Currently equipped weapons: Fists";
                }
                echo "</br>";
                ...
                if ($row['inmedium']) {
                    ...
                    if (!$spriteeffects[0]) {
                        ...
                        $powerbonus = substr($spriteeffects[0], 6);
                    }
                ...
                if ($row['inmedium']) {
                    ...
                    echo "This player hasn't entered the medium yet<br/>";
                }
                ...
                if ($row['lasttick'] != 0) {
                    echo "Last online: " . date("F j, G:i \U\T\C", $row['lasttick']) . " (" . $timediff . " hours ago)";
                } else {
                    echo "Last online: Never";
                }
                echo "<br />";
                echo "<br />";
            }
