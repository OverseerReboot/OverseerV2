...
if (empty($_SESSION['username'])) {
        ...
        if ($feedrow['ID'] == $_GET['view']) {
            ...
            if (!empty($_POST['body'])) {
                if ($accrow['modlevel'] >= 0) {
                    ...
                    $exstring = ": ";
                    if ($accrow['modlevel'] > 0) {
                        $exstring = " (Level " . strval($accrow['modlevel']) . " Mod): ";
                    }
                    if ($accrow['modlevel'] >= 99) {
                        $exstring = " (Developer): ";
                    }
                    if ($accrow['modlevel'] >= 10) {
                        $exstring = " (G. Moderator): ";
                    }
                    if ($feedrow['user'] == $username) {
                        $exstring = " (Submitter): ";
                    }
    ...
    if ($accrow['modlevel'] > 0) {
        ...
        if ($accrow['modlevel'] >= 10) {
            echo "- You have the powers of a Global Moderator and can access <a href='devtools/index.php'>a variety of tools</a>.<br />";
        }
        if ($accrow['modlevel'] >= 99) {
