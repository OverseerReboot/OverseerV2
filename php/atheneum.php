...
if (empty($_SESSION['character'])) {
    ...
    if ($showstring == "") {
        ...
        if ($percents <= 1) {
            ...
            echo "You've got a good starting assortment of items - time to mash them together randomly!";
        } elseif ($percents <= 5) {
            echo "You can find a lot of exotic items in the dungeons!";
        } elseif ($percents <= 10) {
            echo "Don't forget, you can find different kinds of loot from different dungeons. Explore as many lands as you can!";
        } elseif ($percents <= 15) {
            echo "Your session has discovered over one tenth of all the items this multiverse has to offer. That's nothing to sneeze at!";
        } elseif ($percents <= 25) {
            echo "Your collection is coming along quite nicely. Now's the perfect time to scour the Item List and find items within your reach!";
        } elseif ($percents <= 35) {
            echo "Now THAT is a collection! You and your friends are doing very well, but can you go ALL THE WAY...?";
        } elseif ($percents <= 45) {
            echo "AHA, the item pile doesnt stop from getting TALLER.";
        } elseif ($percents <= 55) {
            echo "How HIGH do you even have to BE just to DO something like that.........";
        } elseif ($percents <= 65) {
            echo "This selection has too many PRICES and VAULES!";
        } elseif ($percents <= 75) {
            echo "Ok jesus christ that is a lot of items. Seriously that's like way more than enough to play this game how do you even have the time???";
        } elseif ($percents <= 85) {
            echo "This is starting to get out of hand... I was only joking when I said you could go ALL THE WAY...";
        } elseif ($percents <= 95) {
            echo "MAYDAY! MAYDAY! ITEM COLLECTION REACHING CRITICAL MASS! BAIL, FOR THE LOVE OF HUSSIE, BAIL!!!";
        } elseif ($percents < 100) {
